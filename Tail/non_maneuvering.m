 function [target_state,target_meas] = non_maneuvering(Result_Detection,Velocity,total_time)
...
target_state(:,1)=[Result_Detection(1,1);Velocity(1,1);Result_Detection(1,2);Velocity(1,2)]; % initial position
