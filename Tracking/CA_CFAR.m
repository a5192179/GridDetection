function [data_Alarm]=CA_CFAR(data,N_Azi,N_APro,N_Range,N_RPro,T,mode)
...
% T      :The threshold of CA-CFAR or the threshold index of OS-CFAR
...
%           area 5
            if Ai-floor(N_Azi/2)>0 && Ai+floor(N_Azi/2)<=NA && Ri-floor(N_Range/2)>0 && Ri+floor(N_Range/2)<=NR
              ...
              data0=data0/(N_Azi*N_Range-(2*N_APro+1)*(2*N_RPro+1));
%           area 1    
            elseif Ai-floor(N_Azi/2)<=0 && Ri-floor(N_Range/2)<=0
                if Ai==1 && Ri==1
                    ...
                    data0=data0/(ceil(N_Azi/2)*ceil(N_Range/2)-(N_APro+1)*(N_RPro+1));
                elseif Ai==1 && Ri~=1
                    data0=sum(sum(data(1:Ai+floor(N_Azi/2),1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(1:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/(ceil(N_Azi/2)*(ceil(N_Range/2)+Ri-1)-(N_APro+1)*(2*N_RPro+1));
                elseif Ai~=1 && Ri==1
                    data0=sum(sum(data(1:Ai+floor(N_Azi/2),1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,1:Ri+N_RPro)));
                    data0=data0/((ceil(N_Azi/2)+Ai-1)*ceil(N_Range/2)-(2*N_APro+1)*(N_RPro+1));
                else
                   data0=sum(sum(data(1:Ai+floor(N_Azi/2),1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/((ceil(N_Azi/2)+Ai-1)*(ceil(N_Range/2)+Ri-1)-(2*N_APro+1)*(2*N_RPro+1)); 
                end
...
%           area 2              
                if Ai==1
                    data0=sum(sum(data(1:Ai+floor(N_Azi/2),Ri-floor(N_Range/2):Ri+floor(N_Range/2))))...
                        -sum(sum(data(1:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/(ceil(N_Azi/2)*N_Range-(N_APro+1)*(2*N_RPro+1));
                else
                    data0=sum(sum(data(1:Ai+floor(N_Azi/2),Ri-floor(N_Range/2):Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/((ceil(N_Azi/2)+Ai-1)*N_Range-(2*N_APro+1)*(2*N_RPro+1)); 
                end
...
%           area 3 
                ...
                elseif Ai==1 && Ri~=NR
                    data0=sum(sum(data(1:Ai+floor(N_Azi/2),Ri-floor(N_Range/2):NR)))...
                        -sum(sum(data(1:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/(ceil(N_Azi/2)*(ceil(N_Range/2)+NR-Ri)-(N_APro+1)*(2*N_RPro+1));
                elseif Ai~=1 && Ri==NR
                    data0=sum(sum(data(1:Ai+floor(N_Azi/2),Ri-floor(N_Range/2):NR)))...
                   ...
                   data0=sum(sum(data(1:Ai+floor(N_Azi/2),Ri-floor(N_Range/2):NR)))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                   data0=data0/((ceil(N_Azi/2)+Ai-1)*(ceil(N_Range/2)+NR-Ri)-(2*N_APro+1)*(2*N_RPro+1)); 
                end
...
%           area 4
                if Ri==1
                    data0=sum(sum(data(Ai-floor(N_Azi/2):Ai+floor(N_Azi/2),1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,1:Ri+N_RPro)));
                    data0=data0/(N_Azi*ceil(N_Range/2)-(2*N_APro+1)*(N_RPro+1));
                else
                    data0=sum(sum(data(Ai-floor(N_Azi/2):Ai+floor(N_Azi/2),1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/(N_Azi*(ceil(N_Range/2)+Ri-1)-(2*N_APro+1)*(2*N_RPro+1)); 
                end
...
%           area 6
                if Ri==NR
                    ...
                    data0=sum(sum(data(Ai-floor(N_Azi/2):Ai+floor(N_Azi/2),Ri-floor(N_Range/2):NR)))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/(N_Azi*(ceil(N_Range/2)+NR-Ri)-(2*N_APro+1)*(2*N_RPro+1)); 
                end
%           area 7    
            elseif Ai+floor(N_Azi/2)>NA && Ri-floor(N_Range/2)<=0
                ...
                elseif Ai~=NA && Ri==1
                    data0=sum(sum(data(Ai-floor(N_Azi/2):NA,1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,1:Ri+N_RPro)));
                    data0=data0/((ceil(N_Azi/2)+NA-Ai)*ceil(N_Range/2)-(2*N_APro+1)*(N_RPro+1));
                else
                   data0=sum(sum(data(Ai-floor(N_Azi/2):NA,1:Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/((ceil(N_Azi/2)+NA-Ai)*(ceil(N_Range/2)+Ri-1)-(2*N_APro+1)*(2*N_RPro+1)); 
                end                
...
%           area 8              
                if Ai==NA
                    ...
                    data0=sum(sum(data(Ai-floor(N_Azi/2):NA,Ri-floor(N_Range/2):Ri+floor(N_Range/2))))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                    data0=data0/((ceil(N_Azi/2)+NA-Ai)*N_Range-(2*N_APro+1)*(2*N_RPro+1)); 
                end
...
%           area 9 
                ...
                elseif Ai~=NA && Ri==NR
                   ...
                   data0=sum(sum(data(Ai-floor(N_Azi/2):NA,Ri-floor(N_Range/2):NR)))...
                        -sum(sum(data(Ai-N_APro:Ai+N_APro,Ri-N_RPro:Ri+N_RPro)));
                   data0=data0/((ceil(N_Azi/2)+NA-Ai)*(ceil(N_Range/2)+NR-Ri)-(2*N_APro+1)*(2*N_RPro+1)); 
                end
            else
